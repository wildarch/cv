...
\cventry{02/2023 -- \textit{08/2023 (expected)}}{MSc Thesis: Efficient Processing of User-Provided Graph Algorithms in a Graph Database}{TU Delft / \mbox{TU Eindhoven}}{Delft}{}{
    In this joint project between TU Delft and TU Eindhoven, I am researching how to design a user-friendly programming language for expressing graph algorithms that can be compiled and executed efficiently inside the \href{https://avantgraph.io/}{AvantGraph Database}.
    I am currently developing the compiler for this language, which will optimize and transform imperative programs into a query operator graph.
    My thesis project will allow the embedding of graph algorithms directly into graph queries, which can then be holistically optimized and executed.
}
