...
\cventry{09/2015 -- 07/2018}{Computer Science BSc}{Eindhoven University of Technology}{Eindhoven}{Cum laude}{
    Computer Science bachelor with specializations in Security, Artificial Intelligence and Computer Architecture. GPA: 8.55/10.0
}

\cventry{09/2009 -- 06/2015}{Pre University Education}{Gymnasium Camphusianum}{Gorinchem}{Cum laude}{
    Secondary education in preparation for academic studies, including the study of ancient Greek and advanced calculus.
}
...
\cventry{09/2018 -- 05/2019}{Designer}{Prodrive Technologies B.V.}{Eindhoven}{\url{prodrive-technologies.com}}{
    ...
    Switched to the newly created DevInfra team to assess the viability of the Rust programming language for use at Prodrive and promote it.
...
\cvitem{Technologies}{
    ...
    \href{https://www.antlr.org/}{ANTLR},
    \href{https://www.vim.org/}{Vim},
    \href{https://bazel.build/}{Bazel},
    \href{https://developer.nvidia.com/cuda-toolkit}{NVIDIA CUDA},
...
\cvitem{Cooking}{
    ...
    My collection of recipes is available at \url{https://github.com/wildarch/mono/tree/main/recipes/collections}.
}

\cvitem{Climbing}{
    I like bouldering and top-rope climbing. I hope to try outdoor climbing in the future.
}
